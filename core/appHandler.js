...
module.exports.userSearch = function (req, res) {
  const query = "SELECT name,id FROM Users WHERE login='" + req.body.login + "'"
...
module.exports.bulkProducts = function (req, res) {
  if (req.files.products && req.files.products.mimetype == 'text/xml') {
    const products = libxmljs.parseXmlString(req.files.products.data.toString('utf8'), { noent: true, noblanks: true })
